  ...
  <section className="gs-block" id="product">
    <div className="wrap">
      <div className="gs-sec-center">
        ...
        <Title level={1} className="gs-sec-h" style={{color:"var(--ink)",lineHeight:1.12,fontWeight:800}}>One brain for everything your company knows.</Title>
        <Paragraph className="gs-sec-lede" style={{fontSize:"18px",paddingBottom:30,color:"var(--muted)"}}>
          No migration, no new system to learn. Connect your tools and your second brain starts answering in minutes — with permissions that carry over automatically.
        </Paragraph>
      </div>
