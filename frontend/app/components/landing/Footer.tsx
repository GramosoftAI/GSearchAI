    ...
    <footer className="gs-footer">
      <div className="wrap">
          ...
          <Col xs={24} lg={8} className="gs-foot-brand-col">
            <div className="gs-foot-brand">
              ...
              <Paragraph style={{ fontSize: 14, color: "var(--muted)", maxWidth: 300, marginTop: 14 }}>
                Your company&apos;s second brain &mdash; AI search connected across every tool your team uses. A Gramosoft product.
              </Paragraph>
            </div>
          </Col>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 13.5, color: "var(--faint)", flexWrap: "wrap", gap: 12 }}>
          <span>
            &copy; {new Date().getFullYear()} Gramosoft Private Limited &middot;{" "}
            <a href="/privacy-policy" style={{ color: "inherit", textDecoration: "none" }}>Privacy</a> &middot;{" "}
            <a href="/terms" style={{ color: "inherit", textDecoration: "none" }}>Terms</a> &middot;{" "}
