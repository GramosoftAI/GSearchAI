...
async def run():
    ...
    queries = [
        ...
        "How did the pilot react to the engine failure?",
        "What were the weather conditions during the flight?",
        "Describe the damage to the aircraft.",
        "What are the safety recommendations from the board?",
        "What was the flight crew's training history?"
    ]
    
    print("Testing PDF <-> PDF Genuine Topic Switches (Apple pinned)")
    for q in queries:
